...
import { EntityTypeID } from "../entity_type"
import { ItemID } from "../item"
import { ColorID } from "./color"

/* Auto-generated */
export type ObjectiveCriterionID =
  | 'air'
  | 'armor'
  | 'deathCount'
  | 'dummy'
  ...
  | 'health'
  | 'level'
  | `killedByTeam.${ColorID}`
  | `minecraft.broken:minecraft.${BlockId}`
  | `minecraft.mined:minecraft.${BlockId}`
  | `minecraft.killed:minecraft.${EntityTypeID}`
  | `minecraft.killed_by:minecraft.${EntityTypeID}`
  ...
  | `minecraft.crafted:minecraft.${ItemID}`
  | `minecraft.dropped:minecraft.${ItemID}`
  | `minecraft.picked_up:minecraft.${ItemID}`
  | `minecraft.used:minecraft.${ItemID}`
